...
async def start_yukki():
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await ljk(functions.channels.JoinChannelRequest(channel="@BLACK_DRAGON_FIGHTER_CLAN"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐁𝐋𝐀𝐂𝐊 𝐃𝐑𝐀𝐆𝐎𝐍 𝐅𝐈𝐆𝐇𝐓𝐄𝐑 𝐉𝐎𝐈𝐍 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐆𝐑𝐎𝐔𝐏 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘✅")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
